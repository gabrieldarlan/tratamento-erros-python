...
class ContaCorrente:
    ...
    def __set_agencia(self, value):
        ...
        if value <= 0:
            raise ValueError("O tributo agencia deve ser maior que zero")
    ...
    def __set_numero(self, value):
        ...
        if value <= 0:
            raise ValueError("O tributo numero deve ser maior que zero")
    ...
    def saldo(self, value):
        ...
        if value <= 0:
            raise ValueError("O tributo saldo deve ser maior que zero")
...
def main():
    ...
    while True:
        try:
            ...
            agencia = int(input('Número de agencia:\n'))
